...
const AdminChat = () => {
  ...
  const roomId = 'general'; // Admin monitors general room
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden h-[calc(100vh-12rem)] flex flex-col">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-4">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold text-white">General Chat</h2>
                  <p className="text-blue-100 text-sm">Communicate with all students</p>
                </div>
                ...
                <div className="space-y-4">
                  {messages.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-full text-center py-12">
                      ...
                      <p className="text-gray-500">Start the conversation with your students!</p>
                    </div>
                  ) : (
                    messages.map((msg, index) => {
                      const isMine = isMyMessage(msg);
                      const showAvatar = index === 0 || !isMyMessage(messages[index - 1]) !== !isMine;
                      const senderName = msg.sender?.firstName || 'Student';
